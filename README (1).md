...
Generally a lower frequency means that the waves themselves are longer and travel further, in both open and congested areas as object penetration is also exceptional. On the other hand they have a wide [Fresnel zone](<README (1).md#fresnel-zone>) which means the antennas cannot be close to the ground.
